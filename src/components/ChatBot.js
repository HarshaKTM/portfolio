...
const ChatBot = () => {
  ...
  const [useLocalFallback, setUseLocalFallback] = useState(true); // Using local responses - no API key needed
          ...
          >
            ...
            <div className="h-80 overflow-y-auto p-4 bg-gray-50 dark:bg-gray-900">
              {messages.map((msg, index) => (
                ...
                >
                  <div
                    className={`inline-block rounded-lg px-4 py-2 max-w-[85%] ${msg.type === 'user'
            ...
            >
              ...
              <button
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center ${inputMessage.trim()
